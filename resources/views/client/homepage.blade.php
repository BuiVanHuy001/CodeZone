                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="rbt-card variation-01 rbt-hover">
                                        <div class="rbt-card-img">
                                            <a href="">
                                                <img src="{{ asset('images/course/classic-lms-01.jpg') }}" alt="Card image">
                                        ...
                                        <div class="rbt-card-body">
                                            ...
                                            <h4 class="rbt-card-title"><a href="">The Ultimate React
                                                    Course 2025: React, Next.js, Redux & More</a>
                                            </h4>
                                            <p class="rbt-card-text">Master modern React from beginner to advanced! Next.js,
                                                Context API, React Query, Redux, Tailwind, advanced patterns</p>
                                ...
                                <div class="swiper-slide">
                                    <div class="rbt-card variation-01 rbt-hover">
                                        <div class="rbt-card-img">
                                            <a href="">
                                                <img src="{{ asset('images/course/course-01.jpg') }}" alt="Card image">
                                                <div class="rbt-badge-3 bg-white">
                                                    <span>-40%</span>
                                                    <span>Off</span>
                                                </div>
                                        ...
                                        <div class="rbt-card-body">
                                            ...
                                            <h4 class="rbt-card-title"><a href="">Microservices with Node
                                                    JS and React</a>
                                            </h4>
                                            <p class="rbt-card-text">Build, deploy, and scale an E-Commerce app using
                                                Microservices built with Node, React, Docker and Kubernetes</p>
                                            <div class="rbt-review">
                                                <div class="rating">
                                                    <i class="fas fa-star"></i>
                                                    <i class="fas fa-star"></i>
                                ...
                                <div class="swiper-slide">
                                    <div class="rbt-card variation-01 rbt-hover">
                                        ...
                                        <div class="rbt-card-body">
                                            ...
                                            <h4 class="rbt-card-title"><a href="">React</a>
                                            </h4>
            ...
            <div class="row g-5 align-items-start mb--30">
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="section-title">
                        <h4 class="title">Course Categoies.</h4>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="read-more-btn text-start text-md-end">
                        <a class="rbt-btn rbt-switch-btn bg-primary-opacity btn-sm" href="">
            ...
            <div class="row g-5">
                        ...
                        <div class="rbt-card-body">
                            <div class="rbt-card-top">
                                ...
                                <div class="rbt-bookmark-btn">
                                    <a class="rbt-round-btn" title="Đánh dấu" href="#"><i class="feather-bookmark"></i></a>
                                </div>
                            </div>

                            <h4 class="rbt-card-title"><a href="">Microservices with Node.js and
                                    React</a>
                            </h4>
                            ...
                            <p class="rbt-card-text">Build, deploy, and scale an E-Commerce app using Microservices built
                                with Node, React, Docker and Kubernetes</p>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12" data-sal-delay="200" data-sal="slide-up" data-sal-duration="800">
                    <div class="rbt-card variation-01 rbt-hover">
                        <div class="rbt-card-img">
                            <a href="">
                                <img src="{{ asset('images/course/classic-lms-02.jpg') }}" alt="Card image">
                                <div class="rbt-badge-3 bg-white">
                                    <span>-40%</span>
                                    <span>Off</span>
                                </div>
                        ...
                        <div class="rbt-card-body">
                            ...
                            <h4 class="rbt-card-title"><a href="">Go: The Complete Developer's Guide
                                    (Golang)</a>
                            </h4>
                            <ul class="rbt-meta">
                            ...
                            <p class="rbt-card-text">Master the fundamentals and advanced features of the Go Programming
                                Language (Golang).</p>
                            <div class="rbt-author-meta mb--10">
                                <div class="rbt-avater">
                                    <a href="#">
                                ...
                                <div class="rbt-author-info">
                                    Bởi <a href="">Angela</a> Trong <a href="#">Phát triển</a>
                                </div>
                            </div>
                            <div class="rbt-card-bottom">
                                <div class="rbt-price">
                                ...
                                <a class="rbt-btn-link left-icon" href=""><i class="feather-shopping-cart"></i>
                                    Thêm vào Giỏ hàng</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                    <div class="rbt-card variation-01 rbt-hover">
                        <div class="rbt-card-img">
                            <a href="">
                                <img src="{{ asset('images/course/classic-lms-03.jpg') }}" alt="Card image">
                                <div class="rbt-badge-3 bg-white">
                                    <span>-40%</span>
                                    <span>Off</span>
                                </div>
                        ...
                        <div class="rbt-card-body">
                            ...
                            <h4 class="rbt-card-title"><a href="">Fundamentals of Backend Engineering</a>
                            </h4>
                            <ul class="rbt-meta">
                                <li><i class="feather-book"></i>8 Bài học</li>
                                <li><i class="feather-users"></i>30 Học viên</li>
                            </ul>
                            <p class="rbt-card-text">Understand backend communication design patterns, protocols, execution
                                and proxying</p>
                            ...
                            <div class="rbt-author-meta mb--20">
                                ...
                                <div class="rbt-author-info">
                                    Bởi <a href="">Slaughter</a> Trong <a href="#">Ngôn ngữ</a>
                                </div>
                            </div>
                            <div class="rbt-card-bottom">
                                <div class="rbt-price">
                                    <span class="current-price">2.000.000₫</span>
                                    <span class="off-price">2.500.000₫</span>
                                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="rbt-card variation-01 rbt-hover">
                        <div class="rbt-card-img">
                            <a href="">
                                <img src="{{ asset('images/course/classic-lms-04.jpg') }}" alt="Card image">
                                <div class="rbt-badge-3 bg-white">
                                    <span>-40%</span>
                                    <span>Off</span>
                                </div>
                        ...
                        <div class="rbt-card-body">
                            ...
                            <h4 class="rbt-card-title"><a href="">Web Front To Back</a>
                            </h4>
                            <ul class="rbt-meta">
                            ...
                            <div class="rbt-author-meta mb--20">
                                <div class="rbt-avater">
                                    <a href="#">
                                        <img src="{{ asset('images/client/avatar-01.png') }}" alt="">
                                    </a>
                                </div>
                                <div class="rbt-author-info">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12" data-sal-delay="200" data-sal="slide-up" data-sal-duration="800">
                    <div class="rbt-card variation-01 rbt-hover">
                        <div class="rbt-card-img">
                            <a href="">
                                <img src="{{ asset('images/course/classic-lms-05.jpg') }}" alt="Card image">
                                <div class="rbt-badge-3 bg-white">
                                    <span>-40%</span>
                                    <span>Off</span>
                                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">
                    <div class="rbt-card variation-01 rbt-hover">
                        <div class="rbt-card-img">
                            <a href="">
                                <img src="{{ asset('images/course/classic-lms-06.jpg') }}" alt="Card image">
                                <div class="rbt-badge-3 bg-white">
                                    <span>-40%</span>
                                    <span>Off</span>
                                </div>
    ...
    <div class="rbt-rbt-blog-area rbt-section-gapTop bg-color-white">
        <div class="container">
            <div class="row mb--55 g-5 align-items-end">
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="section-title text-start">
                        <span class="subtitle bg-pink-opacity">Top Blogs</span>
                        <h2 class="title">Check Out <span class="color-primary">Our Latest Updates</span></h2>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="load-more-btn text-start text-md-end">
            ...
            <div class="row g-5">
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="rbt-card variation-02 rbt-hover">
                        <div class="rbt-card-img">
                            <a href="">
                                <img src="{{ asset('images/blog/blog-grid-01.jpg') }}" alt="Card image"></a>
                        </div>
                        <div class="rbt-card-body">
                            <h5 class="rbt-card-title"><a href="">Is lms The Most Trending Thing Now?</a>
                            </h5>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="rbt-card variation-02 rbt-hover">
                        <div class="rbt-card-img">
                            <a href="">
                                <img src="{{ asset('images/blog/blog-grid-02.jpg') }}" alt="Card image"> </a>
                        </div>
                        <div class="rbt-card-body">
                            <h5 class="rbt-card-title"><a href="">Learn How More Money With
                                    lms.</a></h5>
                            <p class="rbt-card-text">It is a long-established fact that a reader.</p>
                            <div class="rbt-card-bottom">
                                <a class="transparent-button" href="">Learn
                                    More<i>
                                        <svg width="17" height="12" xmlns="http://www.w3.org/2000/svg">
                                            <g stroke="#27374D" fill="none" fill-rule="evenodd">
                                                <path d="M10.614 0l5.629 5.629-5.63 5.629"/>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="rbt-card variation-02 rbt-hover">
                        <div class="rbt-card-img">
                            <a href="">
                                <img src="{{ asset('images/blog/blog-grid-03.jpg') }}" alt="Card image"> </a>
                        </div>
                        <div class="rbt-card-body">
                            <h5 class="rbt-card-title"><a href="">Understand The Background Of
                                    lms.</a></h5>
                            <p class="rbt-card-text">It is a long-established fact that a reader.</p>
                            <div class="rbt-card-bottom">
                                <a class="transparent-button" href="">Learn
