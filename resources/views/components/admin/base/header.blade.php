            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        >
                            <img
                                src="{{ asset('images/flags/spain.svg') }}"
                                alt="user-image"
                                class="me-2 rounded"
                                height="18"
                            />
                        ...
                        >
                            <img
                                src="{{ asset('images/flags/germany.svg') }}"
                                alt="user-image"
                                class="me-2 rounded"
                                height="18"
                            />
                        ...
                        >
                            <img
                                src="{{ asset('images/flags/italy.svg') }}"
                                alt="user-image"
                                class="me-2 rounded"
                                height="18"
                            />
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <p class="mb-0 fs-11 fw-medium text-uppercase text-muted">
                                                    <span>
                                                        <i class="mdi mdi-clock-outline"></i> Just 30 sec ago
                                                    </span>
                                                </p>
                                            </div>
                                    ...
                                    <div class="text-reset notification-item d-block dropdown-item position-relative">
                                        <div class="d-flex">
                                            <img src="{{ Vite::asset('resources/assets/admin/images/users/avatar-2.jpg') }}" class="me-3 rounded-circle avatar-xs flex-shrink-0" alt="user-pic"/>
                                            <div class="flex-grow-1">
                                                <a href="#!" class="stretched-link">
                                    ...
                                    >
                                        <div class="d-flex">
                                            <img
                                                src="{{ Vite::asset('resources/assets/admin/images/users/avatar-8.jpg') }}"
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <div class="d-flex">
                                            <img
                                                src="{{ Vite::asset('resources/assets/admin/images/users/avatar-3.jpg') }}"
                                ...
                                >
                                    ...
                                    >
                                        <div class="d-flex">
                                            <img
                                                src="{{ Vite::asset('resources/assets/admin/images/users/avatar-2.jpg') }}"
                                                class="me-3 rounded-circle avatar-xs"
                                                alt="user-pic"
                                            />
                                            <div class="flex-grow-1">
                                ...
                                >
                                    ...
                                    >
                                        <div class="d-flex">
                                            <img
                                                src="{{ Vite::asset('resources/assets/admin/images/users/avatar-6.jpg') }}"
                                                class="me-3 rounded-circle avatar-xs"
                                                alt="user-pic"
                                            />
                                            <div class="flex-grow-1">
                                    ...
                                    <div class="text-reset notification-item d-block dropdown-item">
                                        <div class="d-flex">
                                            <img src="{{ Vite::asset('resources/assets/admin/images/users/avatar-8.jpg') }}" class="me-3 rounded-circle avatar-xs" alt="user-pic"/>
                                            <div class="flex-grow-1">
                                                <a href="" class="stretched-link">
