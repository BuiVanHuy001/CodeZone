...
<div class="accordion-item card">
    ...
    <div id="accCollapseBuilder" class="accordion-collapse collapse" aria-labelledby="accBuilder" wire:ignore.self>
        <div class="accordion-body card-body">
            @foreach($modules as $moduleIndex => $module)
                <div class="accordion-item card mb--20">
                    <h2 class="accordion-header card-header rbt-course" id="accModules{{ $moduleIndex }}">
                        ...
                        <span wire:click="removeModule({{$moduleIndex}})" class="rbt-course-icon rbt-course-del"></span>
                    </h2>
            ...
            <button class="rbt-btn btn-md btn-gradient hover-icon-reverse"
                    type="button" wire:click="createModule">
    ...
    @teleport('body')
    <livewire:client.course-creation.components.builders.module.module-create wire:key="module-create-modal"/>

    <livewire:client.course-creation.components.builders.module.module-update :moduleTitle="$modules[$selectedModule]['title']" wire:key="module-update-modal"/>

    <livewire:client.course-creation.components.builders.lesson.lesson-create wire:key="lesson-create-modal"/>
    @endteleport
</div>
