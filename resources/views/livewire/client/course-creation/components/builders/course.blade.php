                                        ...
                                        <div class="course-field mb--20" x-data="{ showAssessment: false }">
                                            ...
                                            @if(isset($newLesson['assessments']))
                                                @switch($newLesson['assessments']['type'])
                                                    @case('quiz')
                                                        <livewire:client.course-creation.components.builders.assessment-types.quiz wire:model="newLesson.assessments"/>
                                                        @break
                                                    @case('assignment')
                                                        <livewire:client.course-creation.components.builders.assessment-types.assignment wire:model="newLesson.assessments"/>
                                                        @break
                                                    @case('programming')
                                                        <livewire:client.course-creation.components.builders.assessment-types.programming wire:model="newLesson.assessments"/>
                                                        @break
                                                @endswitch
                                            @endif
                                        </div>
