                ...
                <div id="accCollapseOne" @class([
                    ...
                    <div class="accordion-body card-body">
                        <div class="rbt-course-field-wrapper rbt-default-form">
                            <livewire:client.course-creation.components.inputs.text-input label="Course title"
                            ...
                            <livewire:client.course-creation.components.inputs.text-input label="Course heading" wire:model="heading"
                                        ...
                                        <div class="col-lg-8">
                                            <div class="tab-content">
                                                <div class="tab-pane fade advance-tab-content-1 active show"
                                                    ...
                                                    <livewire:client.course-creation.components.inputs.select-input label="Course Levels"
                                                ...
                                                @if (auth()->user()->isInstructor())
                                                    <div class="tab-pane fade advance-tab-content-1" id="price"
                                                        ...
                                                        <div class="course-field mb--15">
                                                            <livewire:client.course-creation.components.inputs.text-input
                                                ...
                                                @else
                                                    <div class="tab-pane fade advance-tab-content-1" id="batch"
                                                        ...
                                                        <div class="course-field mb--15">
                                                            <livewire:client.course-creation.components.inputs.text-input label="Start time"
                                                            ...
                                                            <livewire:client.course-creation.components.inputs.text-input label="End time"
                                                ...
                                                <div class="tab-pane fade advance-tab-content-1" id="information"
                                                    ...
                                                    <livewire:client.course-creation.components.inputs.textarea-input wire:model="skills"
                                                                                               label="Skills" name="skills"
                                                                                               placeholder="Add your course skills student can gain after your course here."/>
                                                    <livewire:client.course-creation.components.inputs.textarea-input
