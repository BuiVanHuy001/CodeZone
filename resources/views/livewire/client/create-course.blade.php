                                                    ...
                                                    @else
                                                        <li class="nav-item w-100" role="presentation">
                                                            <a href="#" id="batch-tab" data-bs-toggle="tab"
                                                               data-bs-target="#batch" role="tab" aria-controls="batch"
                                                               aria-selected="true">
                                                ...
                                                <div class="tab-pane fade advance-tab-content-1 active show"
                                                    ...
                                                    <div class="course-field mb--20">
                                                        ...
                                                        <div class="rbt-modern-select bg-transparent height-45 mb--10">
                                                            <select wire:model="category" class="w-100" id="category"
                                                                    name="category">
                ...
                <div class="accordion" id="learner">
                    <div class="accordion-item card">
                        <h2 class="accordion-header card-header" id="learner">
                            <button wire:click="setTab('learners')" class="accordion-button" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#accCollapseLearner" aria-expanded="true" aria-controls="">
                                Add learners
                            </button>
                        </h2>
                        <div id="accCollapseLearner" @class(['accordion-collapse collapse', 'show' => in_array('learners', $openTabs)]) aria-labelledby="learner"
                             data-bs-parent="#learner">
                            <livewire:client.business.components.add-learners-builder :openTabs="$openTabs" wire:model="employeesAssigned"/>
                        </div>
                    </div>
                </div>
            @endif
