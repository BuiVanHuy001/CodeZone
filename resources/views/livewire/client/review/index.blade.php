<div>
    <x-client.course-details.reviews.summary :$course/>
    ...
    <div class="about-author-list rbt-shadow-box featured-wrapper mt--30 has-show-more">
        ...
        <div @class([
                ...
                'has-show-more-inner-content' => count($reviews) > 5,
            ])>
                        ...
                        <div class="media-body">
                            ...
                            <div class="content">
                                ...
                                <div class="like-dislike-container">
                                    <p class="text-content">Helpful?</p>
                                    <div class="icons-box">
                                        <div class="icons" wire:click="handleReaction('like', {{ $review->id }})">
                                            <label class="btn-label" for="like-checkbox">
                                                <span class="like-text-content">{{ $review->getFormattedCount($review->like_count) }}</span>
                                        ...
                                        <div class="icons" wire:click="handleReaction('dislike', {{ $review->id }})">
                                            <label class="btn-label" for="dislike-checkbox">
                                                ...
                                                <span class="dislike-text-content">{{ $review->getFormattedCount($review->dislike_count) }}</span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
        ...
        @if($isReviewAllowed)
            <livewire:client.review.create :$course/>
        @endif
    </div>
</div>
