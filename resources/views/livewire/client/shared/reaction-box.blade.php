<div class="like-dislike-container">
    @if(!empty($titleText))
        <p class="text-content">{{ $titleText }}</p>
    @endif
    <div class="icons-box">
        <div class="icons">
            <label class="btn-label m-0" wire:click.prevent="handleReaction('like')">
                <span class="like-text-content">{{ $likeCount }}</span>
                <input class="input-box like-checkbox" type="checkbox">
        ...
        <div class="icons">
            <label class="btn-label m-0" wire:click.prevent="handleReaction('dislike')">
                <input class="input-box dislike-checkbox" type="checkbox">
                ...
                @endif
                <span class="dislike-text-content">{{ $dislikeCount }}</span>
            </label>
        </div>
    </div>
</div>
